...
public class MirrorController {
	...
	//미러번호 입력
		@PutMapping("/create")
		public void putAccountProfile(@RequestParam("serialNum") String serialNum) {
			mapper.insertMirrorProfile(serialNum);
		}
	//미러 계정 연결
	@PutMapping("/connect")
	public void connectMirror(@RequestParam("serialNum") String serialNum, @RequestParam("accountIndex") int accountIndex) {
		...
		mapper.accountconnectMirror(serialNum, accountIndex);
	}
	@PostMapping("/login")
